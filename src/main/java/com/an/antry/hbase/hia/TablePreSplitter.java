...
public class TablePreSplitter {
    ...
    public static final String usage = "tablepresplit commands ...\n" + "  help - print this message and exit.\n"
    ...
    public boolean createPreSplitTable(String tableName, String family, String startKey, String endKey, int splits)
            throws IOException {
    ...
    public boolean createPreSplitTable(String tableName, List<String> families, String startKey, String endKey,
            int splits) throws IOException {
